...
public final class ParseUtils {
    ...
    public static Map<String, Object> parseRawDataObject(final RawDataObject rawDataObject, final Map<String, Datatype> datatypeMap) {
    ...
    public static Map<String, Datatype> parseDataTypes(final RawDataObject rawDataObject) {
